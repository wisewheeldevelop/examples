  ...
  return (
    <>
      ...
      <section className="section" id="top">
        <div className="hero">
          <div className="frame frame--hero" ref={heroRef}>
      ...
      <section className="section section--alt" id="agents">
        ...
        <div className={`frame ${deck === "wave" ? "frame--tall" : "frame--wide"}`}>
          <NaorFrame
            key={deck}
      ...
      <section className="section" id="manifesto">
        <div className="frame frame--band">
      ...
      <section className="section section--alt" id="imagegen">
        <div className="section__head">
          ...
          <p className="section__note">
            Every plate on this wall was generated by Naor AI. Drag, scroll or use the arrow keys
            to move through it.
          </p>
        </div>
      ...
      <section className="section" id="library">
        <div className="section__head">
          ...
          <p className="section__note">
            Claude Code, Codex and Cursor, bound as Naor volumes. Click a spine to pull one off
            the shelf and open it.
          </p>
        </div>
        <div className="frame frame--tall">
          <BookshelfScene />
